...
import findRoute, {
  getUrlQuery,
} from '/Users/gaoshaoyun/Documents/gaoshaoyun/12期/lesson6-1019-umi/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/gaoshaoyun/Documents/gaoshaoyun/12期/lesson6-1019-umi',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
