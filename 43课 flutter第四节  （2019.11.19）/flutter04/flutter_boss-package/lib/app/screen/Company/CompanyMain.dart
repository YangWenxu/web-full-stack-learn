...
import 'package:flutter_boss/app/screen/Company/company_detail.dart';

class CompanyMain extends StatefulWidget {
  @override
  CompanyMainState createState() => new CompanyMainState();
}

class CompanyMainState extends State<CompanyMain> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title:
            Text('公 司', style: TextStyle(fontSize: 20.0, color: Colors.white)),
        actions: <Widget>[
          IconButton(
            icon: Icon(
              Icons.find_in_page,
