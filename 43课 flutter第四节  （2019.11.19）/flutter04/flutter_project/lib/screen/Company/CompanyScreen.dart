...
import 'package:flutter_project/item/company_item.dart';
import 'package:flutter_project/model/companylist_item.dart';
import 'package:flutter_project/screen/Company/comany_detail.dart';
...
class _CompanyScreenState extends State<CompanyScreen> {
  ...
  getCompanyList() {
    setState(() {
      _companyList = Company.fromJsonData(
        """
          {
            "list": [
               {
